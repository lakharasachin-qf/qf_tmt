...
public class IOUtils {
    ...
    public static void closeSilently(@Nullable final ParcelFileDescriptor c) {
        if (c == null) return;
        try {
            c.close();
        } catch (@NonNull final Throwable t) {
     ...
     */
    @Nullable
    public static String getRealFilePath(@NonNull final Context context, @Nullable final Uri uri) {

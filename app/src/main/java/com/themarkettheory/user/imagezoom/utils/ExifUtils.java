...
public class ExifUtils {
     ...
     */
    public static int getExifOrientation(@Nullable final String filepath) {
        if (null == filepath)
            return 0;
    ...
    public static int getExifOrientation(@Nullable final ExifInterface exif) {
        int degree = 0;
     ...
     */
    public static boolean loadAttributes(@NonNull final String filepath, @NonNull Bundle out) {
        ExifInterface e;
        try {
     ...
     */
    public static boolean saveAttributes(@NonNull final String filepath, @NonNull Bundle bundle) {
        ExifInterface exif;
        try {
            exif = new ExifInterface(filepath);
        } catch (IOException e) {

...
public class ImageViewTouch extends ImageViewTouchBase {
    ...
    public ImageViewTouch(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public boolean onScroll(@Nullable MotionEvent e1, @Nullable MotionEvent e2, float distanceX,
                            float distanceY) {
        if (!mScrollEnabled)
            return false;

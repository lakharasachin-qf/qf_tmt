package com.themarkettheory.user.imagezoom;
...
import com.themarkettheory.user.imagezoom.easing.Cubic;
import com.themarkettheory.user.imagezoom.easing.Easing;
import com.themarkettheory.user.imagezoom.graphic.FastBitmapDrawable;
import com.themarkettheory.user.imagezoom.utils.IDisposable;
...
public abstract class ImageViewTouchBase extends AppCompatImageView implements IDisposable {
     ...
     */
    public void setImageBitmap(@Nullable final Bitmap bitmap, Matrix matrix,
    ...
    protected void _setImageDrawable(@Nullable final Drawable drawable,
                                     @Nullable final Matrix initial_matrix, float min_zoom, float max_zoom) {
     ...
     * @param matrix
     */
    protected void getProperBaseMatrix(@NonNull Drawable drawable, @NonNull Matrix matrix) {
     ...
     * @param matrix
     */
    protected void getProperBaseMatrix2(@NonNull Drawable bitmap, @NonNull Matrix matrix) {
    ...
    public void printMatrix(@NonNull Matrix matrix) {
    ...
    protected void updateRect(@Nullable RectF bitmapRect, @NonNull RectF scrollRect) {
        if (bitmapRect == null)
            return;
